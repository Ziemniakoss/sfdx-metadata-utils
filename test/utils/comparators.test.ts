...
describe("comparators#compare", () => {
	context("Case insensitive comparison", () => {
		...
		context("Descending order", () => {
			it("should return 0", () =>
				testCompare("test", "Test", 0, true, false));
			it("should return 0", () =>
				testCompare("test", "test", 0, true, false));
			it("should return 1", () =>
				testCompare("ala", "Beka", 1, true, false));
			it("should return -1", () =>
				testCompare("Yeti", "fox", -1, true, false));
		});
	});
	context("Case sensitive comparison", () => {
		...
		context("Descending order", () => {
			...
			it("should return 0", () =>
				testCompare("test", "test", 0, false, false));
			it("should return 1", () =>
				testCompare("ala", "beka", 1, false, false));
			it("should return -1", () =>
...
describe("comparators#compareByField", () => {
	...
	context("Record<string, string[]>", () => {
		it("should return 0", () =>
			testCompareByField("a", ["ala"], ["ALA"], 0));
		it("should return -1", () =>
			testCompareByField("a", ["ala"], ["Beta"], -1));
		it("should return 1", () =>
			testCompareByField("fieldName", ["yeti"], ["fox"], 1));
