...
function testCompare(a: string, b: string, expectedResult: number, caseInsensitive = true, asc = true) {
...
describe("comparators#compare", () => {
	...
	context("Case sensitive comparison", () => {
		...
		context("Descending order", () => {
			it("should return 1", () => testCompare("test", "Test", -1, false, false))
...
function testCompareByField(fieldName: string, valInA, valInB, expectedResult, caseInsensitive= true, asc = true) {
	const a = {
		[fieldName]: valInA
	};
	const b = {
...
describe("comparators#compareByField", () => {
	context("Record<string, string>", () => {
		...
		it('should return 1', () => testCompareByField("fieldName", "yeti", "fox", 1));
	})
	context("Record<string, string[]>", ()=>{
		it('should return 0', () => testCompareByField("a", ["ala"], ["ALA"], 0));
		it('should return -1', () => testCompareByField("a", ["ala"], ["Beta"], -1));
