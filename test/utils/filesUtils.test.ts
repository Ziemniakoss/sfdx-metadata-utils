...
import {extractFileName, findFilesWithExtension} from "../../lib/utils/filesUtils";
...
describe("filesUtils#extractFileName", () => {
	...
	context("Custom extension", () => {
		it(`Should return "Sales"`, () => {
			const result = extractFileName("Sales.profile-meta.xml", "profile-meta.xml")
			equal(result, "Sales")
		})
	})
})
...
describe("filesUtils#findFilesWithExtension", () => {
	context("Files with extension exits", () => {
		it("should return 0", () => {
			return findFilesWithExtension("not-existing-extension")
				.then(filesFound => {
	...
	context("Files with extension dont exist", () => {
		it("should return 4", () => {
			return findFilesWithExtension("existing-extension.xml")
				.then(filesFound => {
